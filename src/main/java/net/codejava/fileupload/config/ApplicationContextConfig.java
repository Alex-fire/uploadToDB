...
import net.codejava.fileupload.dao.FileGetDAOImpl;*/
...
public class ApplicationContextConfig {
	...
	/*@Autowired
	@Bean(name = "fileGetDao")
	public FileGetDAO getUserDownDao(SessionFactory sessionFactory) {
		return new FileGetDAOImpl(sessionFactory);
	}*/
